  ...
  return (
    ...
    >
      <header className="flex justify-between px-12 py-5 border border-slate-700">
        <h2
          className=" font-bold text-[#7cfc00] tracking-wide text-3xl text-slate-200/100 animate__animated animate__jackInTheBox"
          style={{
        ...
        <nav className="flex items-center gap-8">
          ...
          <select
            ...
            className=" text-slate-500 bg-slate-300 w-20 rounded-full focus:ring-[#7cfc00]"
          >
